...
int main()
{
	...
	//actividad 4: hacer mas de  4 ventanas
	//GLfloat vertices[] =
	//{
	//	// Positions            // Colors              // Texture Coords
	//	-0.5f, -0.5f, 0.0f,    1.0f, 1.0f,1.0f,		0.0f,0.0f,
	//	0.5f, -0.5f, 0.0f,	   1.0f, 1.0f,1.0f,		7.5f,0.0f,
	//	0.5f,  0.5f, 0.0f,     1.0f, 1.0f,1.0f,	    7.5f,4.0f,
	//	-0.5f,  0.5f, 0.0f,    1.0f, 1.0f,1.0f,		0.0f,4.0f,
	//};

	//actividad 1 parte de abajo derecha 
	//GLfloat vertices[] =
	//{
	//	 //Positions            // Colors              // Texture Coords
	...
	//actividad 2 parte de arriba izquierda
	//GLfloat vertices[] =
	//{
	//	// Positions            // Colors              // Texture Coords
