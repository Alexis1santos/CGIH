...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.5f));
		...
		//---------------------- agregamos modelo 
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-4.0f, 1.5f, 1.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(-2.0f, -4.0f, -2.0f));
		model = glm::scale(model, glm::vec3(-5.0f, 5.9f, 0.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		

		//ejercicio 1: tres cubos todos con rotacion traslacion y escalado diferente  
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(4.0f, 6.5f, -6.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(-4.0f, -4.0f, -4.0f));
		model = glm::scale(model, glm::vec3(9.0f, 5.0f, 1.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
